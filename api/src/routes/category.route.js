...
const {
  categoryController: { createCategory, getCategories, deleteCategory, getCategoryById },
} = require('../controllers');
...
categoryRouter.post('/', bodyParser.urlencoded({ extended: true }), singleUploadMiddleware('image'), createCategory);
